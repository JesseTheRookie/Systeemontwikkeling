...
class Contact{
    ...
    public function contact_us($data){
       ...
       if($data==true){
           $body="One message received from Haarlem Festival contact us. details are below..<br> first_name='$fname', last_name='$lname', email='$email', phone='$phone', message='$message'";
